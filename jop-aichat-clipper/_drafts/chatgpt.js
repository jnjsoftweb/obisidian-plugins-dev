(() => {
    const userMessageSelector = "article:nth-child(odd)";
    const aiResponseSelector = "article:nth-child(even)";
    // const userMessageSelector = '[data-testid="user-message"]';
    // const aiResponseSelector = "[data-test-render-count]:nth-child(even)";
    ...
    script.onload = () => {
      ...
      const claudeResponses = document.querySelectorAll(aiResponseSelector);
